...
min_sim_mean = c()
min_sim_mean[50] = 0.8
min_sim_mean[100] = 0.4
min_sim_mean[200] = 0.2
min_sim_mean[400] = 0.1
...
AA = egg::ggarrange( plots = 
                       list(FDR_ALL[[1]] + xlab("") + labs(title = methods_names[1]) + theme(legend.position = "none", plot.title = element_text(hjust = 0.5, face = "bold", size=30)),
                            ...
                            FDR_ALL[[9]] + ylab("") + labs(title = methods_names[9]) + theme(legend.position = "none", plot.title = element_text(hjust = 0.5, face = "bold", size=30)),
                            FDR_ALL[[10]] + labs(title = methods_names[10]) + theme(legend.position = "none", plot.title = element_text(hjust = 0.5, face = "bold", size=30)),
                            FDR_ALL[[11]] + ylab("") + labs(title = methods_names[11]) + theme(legend.position = "none", plot.title = element_text(hjust = 0.5, face = "bold", size=30))),
