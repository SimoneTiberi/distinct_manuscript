.typ_cols <- c(pb = "grey50", distinct = "red", mm = "violet", ad = "lightgreen", mast = "orange", scdd = "steelblue")
.typ_labs <- c(pb = "PB", distinct = "distinct", mm= "MM", ad = "AD", mast = "MAST", scdd = "scDD")
...
.meth_cols <- c(
    ...
    "distinct.cpm"          = "red",
    "distinct.logcounts"    = "red3",
    "distinct.vstresiduals" = "orangered",
