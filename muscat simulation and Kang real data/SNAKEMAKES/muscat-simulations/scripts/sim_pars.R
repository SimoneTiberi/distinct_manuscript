...
sim_pars <- list(
    # null simulations
   nill50  = list(nr = 5, p_dd = diag(6)[1, ], seed = 1, lfc = 1, nc = 18 * 50),
   nill100 = list(nr = 5, p_dd = diag(6)[1, ], seed = 1, lfc = 1, nc = 18 * 100),
   nill200 = list(nr = 5, p_dd = diag(6)[1, ], seed = 1, lfc = 1, nc = 18 * 200),
   nill400 = list(nr = 5, p_dd = diag(6)[1, ], seed = 1, lfc = 1, nc = 18 * 400),
    # pure simulations
   de400 = list(nr = 5, p_dd = c(0.9, 0, 0.1, 0, 0, 0), seed = 2, lfc = 1, nc = 18 * 400),
   dp400 = list(nr = 5, p_dd = c(0.9, 0, 0, 0.1, 0, 0), seed = 3, lfc = 1.5, nc = 18 * 400),
   dm400 = list(nr = 5, p_dd = c(0.9, 0, 0, 0, 0.1, 0), seed = 4, lfc = 1.5, nc = 18 * 400),
   db400 = list(nr = 5, p_dd = c(0.9, 0, 0, 0, 0, 0.1), seed = 5, lfc = 3, nc = 18 * 400),
   ...
   de100 = list(nr = 5, p_dd = c(0.9, 0, 0.1, 0, 0, 0), seed = 2, lfc = 1, nc = 18 * 100),
   dp100 = list(nr = 5, p_dd = c(0.9, 0, 0, 0.1, 0, 0), seed = 3, lfc = 1.5, nc = 18 * 100),
   dm100 = list(nr = 5, p_dd = c(0.9, 0, 0, 0, 0.1, 0), seed = 4, lfc = 1.5, nc = 18 * 100),
   db100 = list(nr = 5, p_dd = c(0.9, 0, 0, 0, 0, 0.1), seed = 5, lfc = 3, nc = 18 * 100),
