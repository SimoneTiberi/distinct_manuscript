.typ_cols <- c(pb = "grey50", CDF = "red", mm = "violet", ad = "lightgreen", mast = "orange", scdd = "steelblue")
.typ_labs <- c(pb = "PB", CDF = "CDF", mm= "MM", ad = "AD", mast = "MAST", scdd = "scDD")
...
.meth_cols <- c(
    ...
    "CDF.counts"       = "red",
    "CDF.cpm"          = "red3",
    "CDF.logcounts"    = "orangered",
    "CDF.vstresiduals" = "orangered3",
